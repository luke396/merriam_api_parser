...
class JsonParser:
    ...
    def _parse_single_sense(
        ...
        single_sense_element: dict[str, str |
                                   Any] = single_sense[1]  # type: ignore
        return defaultdict(
            str, zip(single_sense_element.keys(),
                     single_sense_element.values())
        )

    def _parse_dt(self, origin_dt: list[list[str | Any]]) -> defaultdict[str,
                                                                         Any]:
